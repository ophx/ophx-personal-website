...
export default function Discord() {
    ...
    return (
        <div className="fixed bottom-4 right-4 w-80 z-10">
			{!loading && status?.listening_to_spotify && (
                <div className="flex flex-col">
                    <div className="bg-green-500 px-4 py-1 rounded-t-lg">
                        <div className="flex items-center gap-2 justify-center">
                            ...
                            <p className="text-text-main text-sm font-medium uppercase">Ophx Is Listening To Spotify</p>
                        </div>
                    </div>
